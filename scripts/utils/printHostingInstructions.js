...
function printHostingInstructions(
  ...
  console.log('更多项目详情请参考前端项目汇总:');
  console.log();
  // console.log(`  ${chalk.yellow('http://bit.ly/CRA-deploy')}`);
  console.log(`  ${chalk.yellow('http://wiki.inkept.cn/pages/viewpage.action?pageId=17976184')}`);
  console.log();
}
...
function printBaseMessage(buildFolder, hostingLocation) {
  ...
  console.log(`构建目录为: ${chalk.cyan(buildFolder)} , 部署方案请详见项目readme `);
  console.log()
  // console.log(
...
function printStaticServerInstructions(buildFolder, useYarn) {
  console.log('可以启动distServer, 在上线前检查构建文件功能, 命令如下:')
  console.log()
  console.log(`   ${chalk.cyan('npm')} run dist-server`)
