/**
 * https://github.com/webpack-contrib/mini-css-extract-plugin/pull/305/files#diff-0
 * 修复官方问题, 但是目前官方还没有更新, 先用这个修复好的, 功能都在正常
 */
'use strict';
...
MiniCssExtractPlugin.loader = require('mini-css-extract-plugin').loader;
