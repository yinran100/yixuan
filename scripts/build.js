...
const entryCheck = require('./entryCheck')
...
entryCheck()
  ...
  .then(previousFileSizes => {
    // console.log('build require webpackconfig')
    // 这里require的话, 应该可能会被异步加载~
  ...
  .then(
    ({ stats, previousFileSizes, warnings, config }) => {
      ...
      console.log();
      // shouldMinimize && fs.removeSync(paths.appBuild + '/static/js/runtime') // 非压缩的 删除runtime文件夹
...
function build(previousFileSizes, config) {
  ...
  return new Promise((resolve, reject) => {
    ...
    if (config.watch) {
      addHooksHanlder(compiler.compiler || compiler)
    }
  });
}

function addHooksHanlder (compiler) {
